...
if (!isset($_SESSION['authenticated'])) {
    // MD5 hashed password (for demonstration purposes only)
    $stored_hashed_password = '8a16a3a508d0e43e87554388eaabf3e3'; // Hash MD5 untuk password 'password'

    if (isset($_POST['pass']) && md5($_POST['pass']) === $stored_hashed_password) {
